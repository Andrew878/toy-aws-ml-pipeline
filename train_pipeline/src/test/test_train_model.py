...
from train_pipeline.src.main.train_model import create_dummy_data, MODEL_DIR, load_data_and_train, MODEL_STATS_BUCKET
...
def test_create_dummy_data():
    ...
    pd.testing.assert_frame_equal(df_seed, df_seed_same, "DataFrames should be the same with the same seed")
...
def test_load_data_and_train(tmp_path):
    ...
    assert isinstance(loaded_model, LinearRegression), "Loaded model should be a LinearRegression instance"
